   ...
   <div id  = "content"><!-- #content start -->
    ...
    <div class="carousel-inner ci" style = " background-color: #fff;">
       <?php 
                   ...
                   $get_slides = "SELECT * FROM product WHERE catagories = 'others' ORDER BY rand() LIMIT 0,1";
                   
                   $run_slides = mysqli_query($conn,$get_slides);
                   
                   while($row_slides=mysqli_fetch_array($run_slides)){
                       $get_slides2 = "SELECT * FROM product WHERE catagories = 'others' ORDER BY rand() LIMIT 0,1";
                       $run_slides2 = mysqli_query($conn,$get_slides2);
                       $row_slides2=mysqli_fetch_array($run_slides2);

                       $get_slides3 = "SELECT * FROM product WHERE catagories = 'others' ORDER BY rand() LIMIT 0,1";
                       $run_slides3 = mysqli_query($conn,$get_slides3);
                       $row_slides3=mysqli_fetch_array($run_slides3);

                       $get_slides4 = "SELECT * FROM product WHERE catagories = 'others' ORDER BY rand() LIMIT 0,1";
                   ...
                   $get_slides = "SELECT * FROM product WHERE catagories = 'others' ORDER BY rand() LIMIT 1,5";
      ...
      <span class="sr-only">Next</span>
         ...
         <div class = "col-md-3"><!-- col-md-3 start -->
                ...
                if(!isset($_GET['p_cat'])){
                    ...
                    if(!isset($_GET['cat'])){ ?>
                       ...
                       <div class='box'> <!-- box Begin -->
                           <h1><a href="shop.php">Shop</a> / Others</h1>
                           <p>
                   ...
                   <?php 
                        ...
                        if(!isset($_GET['p_cat'])){
                         ...
                         if(!isset($_GET['cat'])){
                            ...
                            $get_products = "SELECT * FROM product WHERE catagories = 'others' ORDER BY 1 DESC LIMIT $start_from,$per_page";
           ...
           <?php
                    ...
                    $query = "SELECT * FROM product WHERE catagories = 'Others'";
                    ...
                    $total_pages = ceil($total_records / $per_page);
                        ...
                        echo "
                            ...
                            <li>
                                ...
                                <a href='others_catagory.php?page=1'> ".'First Page'." </a>
                        ...
                        for($i=1; $i<=$total_pages; $i++){
                            ...
                            <li>
                                ...
                                <a href='others_catagory.php?page=".$i."'> ".$i." </a>
                        ...
                        echo "
                            ...
                            <li>
                                ...
                                <a href='others_catagory.php?page=$total_pages'> ".'Last Page'." </a>

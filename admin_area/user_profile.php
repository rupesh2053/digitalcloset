...
<?php 
    ...
    if(isset($_GET['user_profile'])){
        ...
        $get_user = "SELECT * FROM admins where admn_id='$edit_user'";
        
        $run_user = mysqli_query($conn,$get_user);
        
        $row_user = mysqli_fetch_array($run_user);
        
        $user_id = $row_user['admn_id'];
...
if(isset($_POST['update'])){
    ...
    $update_user = "UPDATE admins SET admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_country='$user_country',admin_contact='$user_contact',admin_job='$user_job',admin_about='$user_about',admin_image='$user_image' WHERE admn_id='$user_id'";

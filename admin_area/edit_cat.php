...
<?php 
    ...
    if(isset($_GET['edit_cat'])){
        ...
        $edit_cat_query = "SELECT * FROM catagories WHERE cat_id='$edit_cat_id'";
                ...
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <textarea type='text' name="cat_desc" cols = "20"  rows = "10" class="form-control"><?php echo $cat_desc; ?></textarea>
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $update_cat = "UPDATE catagories SET cat_title = '$cat_title', cat_desc = '$cat_desc' WHERE cat_id = '$cat_id'";

        ...
        <div class="panel panel-orange"><!-- panel panel-yellow begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php echo $count_p_catagories; ?> </div>
            ...
            <div class="panel-body"><!-- panel-body begin -->
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        $get_customer = "SELECT * FROM tbl_customer WHERE customer_id = '$c_id'";
        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img src="admin_images/<?php echo $admin_image ?>" alt="admin-thumb-info" class="rounded img-responsive" style = "height: 300px; width: 300px; margin-left: 30px">
                    
                    <div class="thumb-info-title"  style = "margin-left: 100px; margin-bottom: -10px"><!-- thumb-info-title begin -->
                ...
                <div class="mb-md" style = "margin-left:30px"><!-- mb-md begin -->

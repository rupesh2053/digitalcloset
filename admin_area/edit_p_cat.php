...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_query = "SELECT * FROM product_catagories WHERE p_cat_id='$edit_p_cat_id'";
                ...
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <textarea type='text' name="p_cat_desc" cols = "20" rows = "10" class="form-control"><?php echo $p_cat_desc; ?></textarea>
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $update_p_cat = "UPDATE product_catagories SET p_cat_title='$p_cat_title', p_cat_desc='$p_cat_desc' WHERE p_cat_id='$p_cat_id'";
              ...
              if($run_p_cat){
                  ...
                  echo "<script>alert('Error occor!')</script>";

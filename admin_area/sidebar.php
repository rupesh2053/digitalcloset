    ...
    <ul class="nav navbar-right top-nav"><!-- nav navbar-right top-nav begin -->
        ...
        <li class="dropdown"><!-- dropdown begin -->
            ...
            <ul class="dropdown-menu"><!-- dropdown-menu begin -->
                <li><!-- li begin -->
                    <a href="index.php?user_profile=<?php echo $admn_id; ?>"><!-- a href begin -->
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_p_cats"><!-- a href begin -->
                        ...
                        <span class="badge"><?php echo $count_p_catagories; ?></span>
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="users" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?user_profile=<?php echo $admn_id; ?>"> Edit User Profile </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
